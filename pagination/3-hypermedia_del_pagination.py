...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        Args:
            index (int): The starting index of the return page.
            page_size (int): The number of items to return. Defaults to 10.

        Returns:
            dict: Contains the index, next_index, page_size, and the data rows.
        """
